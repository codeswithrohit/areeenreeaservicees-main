...
const Billing = () => {
 ...
 <dl className="grid sm:flex gap-x-3 text-sm">
  ...
  ₹{bookingData.includeDonation ? "+1" : "0"}
        ...
        <footer className="bg-white dark:bg-white text-gray-700 dark:text-gray-300 py-6">
  <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto text-center">
    <p className="text-lg font-semibold flex items-center justify-center gap-2">
      ...
      Welcome to Areene Services! We appreciate your choice!
    </p>
    <p className="mt-2">
      For any assistance, feel free to reach out to us:
    </p>
    <p className="mt-1 flex items-center justify-center gap-2">
      <strong>Email:</strong> <span className="flex items-center gap-1"><i className="fas fa-envelope"></i> support@areene.com</span> 
      | 
      <strong>Phone:</strong> <span className="flex items-center gap-1"><i className="fas fa-phone-alt"></i> +1-234-567-890</span>
    </p>
    {/* <p className="mt-4 flex items-center justify-center gap-2">
      <strong>With regards,</strong> <i className="fas fa-heart text-red-500"></i> <strong>Team Areene Services</strong>
    </p> */}
  </div>
</footer>
