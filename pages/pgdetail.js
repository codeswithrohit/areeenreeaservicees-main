      ...
      {activeTab === tab.name && (
        ...
        <div ref={overviewRef} className="mb-8">
          ...
          <FaCheckCircle className="text-green-500 text-xl md:text-2xl" title="Verified" />
              ...
              <p className="text-gray-900 font-bold md:text-lg text-xs flex ml-4 ">  <FaMapMarkerAlt className="text-red-600 mr-1 mt-1" /> {pgdetaildata.nearby},{pgdetaildata.district}</p>
