...
setSortBy(null); // Reset sorting
    ...
    const handleBookMeClick = (type, id) => {
      ...
      router.push(`/resortdetail?id=${id}`);
    };
...
<div className="flex items-center justify-between mt-8 p-4">
  ...
  placeholder="Search Resort by location"
  value={searchQuery}
        ...
        <div className="p-4 bg-white">
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-4 flex-wrap">
              {["Deluxe room king bed", "Deluxe room twin bed", "Junior suite king bed", "Premium villa king bed", "Deluxe suite"].map(room => (
                <button
                  key={room}
