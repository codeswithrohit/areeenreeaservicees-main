...
const Buy = () => {
  ...
  const [selectedPriceRange, setSelectedPriceRange] = useState(50000);
  ...
  setSelectedPriceRange(50000); // Reset to initial value
  setSortBy(null); // Reset sorting
  };
      const handleBookMeClick = (type, id) => {
     
        router.push(`/listing-details-2?id=${id}`);
      };
 ...
 console.log("filterdqta",filteredData) 
  return (
    ...
    <div className="2xl:container 2xl:mx-auto">
            <div className=" md:mt-16 lg:px-20 md:px-6 mt-9 px-4">
                <p className=" text-sm leading-3 text-gray-600 font-normal mb-2">HOME - <p>BUY PROPERTIES</p></p>
